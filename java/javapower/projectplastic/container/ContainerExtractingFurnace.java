...
public class ContainerExtractingFurnace extends Container
{
	...
	public ContainerExtractingFurnace(TileEntityExtractingFurnace tile, EntityPlayer player)
	{
		block_inv = tile;
		...
		this.addSlotToContainer(new SlotOutput(block_inv, 2, 116, 24));
		this.addSlotToContainer(new SlotOutput(block_inv, 3, 116, 44));
	}
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
	{
		 ...
		 else if(TileEntityFurnace.isItemFuel(from) && (getSlot(37).getStack().isEmpty() || getSlot(37).getStack().isItemEqual(from)))
		 {
			 Slot go = getSlot(37);
