...
public class ContainerMicrowaveExtractingFurnace extends Container
{
	IInventory block_inv;
	InventoryPlayer playerInventory;
	
	public ContainerMicrowaveExtractingFurnace(TileEntityMicrowaveExtractingFurnace tile, EntityPlayer player)
	{
		block_inv = tile;
