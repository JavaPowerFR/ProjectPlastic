...
public class GuiMicrowaveOven extends GuiContainer implements IGUITileSync
{
	TileEntityMicrowaveOven tileentity;
	private int progress;
	private int fuel;
	
	public GuiMicrowaveOven(TileEntityMicrowaveOven _tileentity, EntityPlayer player)
	{
		super(new ContainerMicrowaveOven(_tileentity, player));
	...
	{
		mc.renderEngine.bindTexture(ResourceLocationRegister.texture_gui_microwaveoven);
        ...
        fontRenderer.drawString("Microwave Oven", x + 50, y + 6, 0x404040, false);
	...
	{
		return TileEntityMicrowaveOven.class;
	}
