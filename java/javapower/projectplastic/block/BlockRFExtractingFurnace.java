...
import javapower.projectplastic.gui.GuiRFExtractingFurnace;
...
public class BlockRFExtractingFurnace extends BlockBaseContainer implements IGuiRegister
{
    ...
    public BlockRFExtractingFurnace()
    {
        super(Material.IRON, "rfextractingfurnace");
	...
	{
		return new TileEntityRFExtractingFurnace();
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	{
		...
		if(tileentity instanceof TileEntityRFExtractingFurnace)
		{
			InventoryHelper.dropInventoryItems(worldIn, pos, ((TileEntityRFExtractingFurnace)tileentity));
		}
	...
	{
		return new GuiRFExtractingFurnace((TileEntityRFExtractingFurnace) tile, player);
	}

	@Override
	public Container getContainer(TileEntity tile, EntityPlayer player)
	{
		return new ContainerRFExtractingFurnace((TileEntityRFExtractingFurnace) tile, player);
	}
}
