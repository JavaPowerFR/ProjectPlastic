...
import javapower.projectplastic.gui.GuiExtractingFurnace;
...
public class BlockExtractingFurnace extends BlockBaseContainer implements IGuiRegister
{
    ...
    public BlockExtractingFurnace()
    {
        super(Material.IRON, "extractingfurnace");
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	{
		...
		if(tileentity instanceof TileEntityExtractingFurnace)
		{
			InventoryHelper.dropInventoryItems(worldIn, pos, ((TileEntityExtractingFurnace)tileentity));
		}
	...
	{
		return new GuiExtractingFurnace((TileEntityExtractingFurnace) tile, player);
	}

	@Override
	public Container getContainer(TileEntity tile, EntityPlayer player)
	{
		return new ContainerExtractingFurnace((TileEntityExtractingFurnace) tile, player);
	}
}