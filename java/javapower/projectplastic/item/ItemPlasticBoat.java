...
public class ItemPlasticBoat extends ItemBase
{

	public ItemPlasticBoat()
	{
		super("plasticboat");
		setMaxStackSize(1);
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                EntityPlasticBoat entityboat = new EntityPlasticBoat(worldIn, raytraceresult.hitVec.x, flag1 ? raytraceresult.hitVec.y - 0.12D : raytraceresult.hitVec.y, raytraceresult.hitVec.z);
