...
public class ItemPlasticShovel extends ItemToolPlastic
{
	...
	public ItemPlasticShovel()
	{
		super("plasticshovel", 1.5F, -3.0F, EFFECTIVE_ON, "shovel");
	}
	...
	public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> items)
	{
		if(tab == PlasticCraft.creativeTab)
			items.add(new ItemStack(PCItems.item_plasticShovel));
	}
