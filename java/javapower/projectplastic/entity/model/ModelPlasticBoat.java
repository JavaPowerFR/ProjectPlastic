package javapower.projectplastic.entity.model;
...
public class ModelPlasticBoat extends ModelBase implements IMultipassModel
{
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        EntityPlasticBoat EntityPlasticBoat = (EntityPlasticBoat)entityIn;
        ...
        this.renderPaddle(EntityPlasticBoat, 0, scale, limbSwing);
        this.renderPaddle(EntityPlasticBoat, 1, scale, limbSwing);
    }
    ...
    protected void renderPaddle(EntityPlasticBoat boat, int paddle, float scale, float limbSwing)
    {
